...
public class JFramePartieFinal extends JFrame {
	...
	public JFramePartieFinal() {
		...
		gbl_panel_Infos.rowHeights = new int[]{0, 0, 0, 0, 0};
		gbl_panel_Infos.columnWeights = new double[]{1.0, 0.0, Double.MIN_VALUE};
		gbl_panel_Infos.rowWeights = new double[]{0.0, 0.0, 0.0, 0.0, Double.MIN_VALUE};
		...
		panel_Infos.add(lblDgtsParSeconde, gbc_lblDgtsParSeconde);
